    ...
    const ModalEditarPAbrir = (item) => {
        ...
        return (
            <div className="table container">
                        ...
                        {(productos !== undefined && productos.length > 0) ?
                            productos.map(item => {
                                ...
                                return (<tr>
                                    ...
                                    <td><Button onClick={() =>ModalEditarPAbrir(item)} variant="secondary">Editar</Button></td>
                                </tr>
                                );
                            }) :
                            productos !== undefined ?
                ...
                <Modal size="lg" show={showP} onHide={handleCloseP}>
                ...
                <Modal show={showEditarProd} onHide={ModalEditarPCerrar} size ="lg">
                    <Modal.Header closeButton>
                    ...
                    <Modal.Body>
                                            ...
                                            <form className="needs-validation" novaldiate="">
                                                <div className="row g-3">
                                                    ...
                                                    <div className="col-sm-6">
                                                        <label for="talla" className="text-dark form-label">Talla</label>
                                                        <select onChange={changeField} value={formValues.talla} name="talla" className="form-select" id="tallaPrenda" required="">
                                                            {/* <option value={showEditarProd.talla}>{showEditarProd.talla}</option> */}
                                                            <option value="">Choose...</option>
                                                            <option>XS</option>
                                                            <option>S</option>
                                                            <option>M</option>
                        ...
                        {/* {(productosID !== undefined && productosID.length > 0) ?
                            productosID.map(item => {
                                return (<>
                                </>
                                )
                            }) :
                            setProductosID !== undefined ?
                                <div>
                                    Ningun producto coincide con la busqueda
                                </div>
                                :
